...
public class SharedPreferenceManager {
    ...
    // constants.
    private final String PREFERENCES = "bonappetit_preferences";
    ...
    private SharedPreferenceManager() {
            ...
            mSharedPreference = ABTestingApp.getInstance().getSharedPreferences(PREFERENCES, Context.MODE_PRIVATE);
    ...
    public String getPinCode(String key) {
        return mSharedPreference.getString(key, "47475");
    }
